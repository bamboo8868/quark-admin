...
import { ref } from "vue";
import { useMemberCdkGroup } from "./hook";
  ...
  <div class="main">
    <el-form ref="formRef" :inline="true" :model="form" class="search-form bg-bg_color w-full pl-8 pt-3 overflow-auto">
      ...
      <el-form-item label="会员等级" prop="member_level">
        <el-select v-model="form.member_level" placeholder="请选择等级" clearable class="w-35!">
    ...
    <PureTableBar title="会员CDK组管理" :columns="columns" @refresh="onSearch">
      <template #buttons>
